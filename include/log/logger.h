#ifndef __COMWISE__ROBOT_VIEWER_LOG__SPD_LOGGER__H__
#define __COMWISE__ROBOT_VIEWER_LOG__SPD_LOGGER__H__
...
static const std::string kLoggerName = "robot_viewer";
static const std::string kLoggerPath = "/opt/robot_viewer/log";
...
#endif // __COMWISE__ROBOT_VIEWER_LOG__SPD_LOGGER__H__