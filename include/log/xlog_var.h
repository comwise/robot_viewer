...
* @brief log const var
* @author comwise
* @version v1.0 2014/04/02
*/

#ifndef __COMWISE__ROBOT_VIEWER__LOG_XLOG_VAR__H__
#define __COMWISE__ROBOT_VIEWER__LOG_XLOG_VAR__H__
...
#endif // __COMWISE__ROBOT_VIEWER__LOG_XLOG_VAR__H__
