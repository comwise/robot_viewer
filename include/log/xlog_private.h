#ifndef __COMWISE__ROBOT_VIEWER__LOG_XLOG_PRIVATE__H__
#define __COMWISE__ROBOT_VIEWER__LOG_XLOG_PRIVATE__H__
...
#endif // __COMWISE__ROBOT_VIEWER__LOG_XLOG_PRIVATE__H__
