...
void CBaseDialog::SetWinIcon(const QPixmap &pm)
{
  QPixmap pixmap(pm);
  if (pixmap.isNull()) {
    return;
...
///!< @brief CInputBox::SetInputText 设置默认输入
